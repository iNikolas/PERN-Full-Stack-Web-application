...
function App() {
    ...
    useEffect(() => {
        handleGetTodos(currentPage, setCurrentPage, setTodos, setPagination)
    }, [currentPage])
    ...
    return (
        <>
            ...
            <div className='container d-flex flex-column align-items-center'>
                <div className='w-100'><InputTodo todos={todos} setTodos={setTodos} pagination={pagination} setPagination={setPagination} setCurrentPage={setCurrentPage}/></div>
